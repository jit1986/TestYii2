...
class m180118_072520_create_table_country extends Migration {
    ...
    public function safeUp() {
        ...
        $this->createTable('{{country}}', [
            'CountryID' => $this->integer(11)->notNull()->append('AUTO_INCREMENT PRIMARY KEY'),
            'CountryName' => $this->string(50)->notNull(),
            'CountryCode' => $this->string(10)->notNull(),
            'CountryPhoneCode' => $this->string(10),
            'CountryLatitude' => $this->string(20),
            'CountryLongitude' => $this->string(20),
            'CountryCurrencyID' => $this->integer(11),
                ], $tableOptions);

        $this->addForeignKey('CountryCurrencyID', '{{country}}', 'CountryCurrencyID', '{{currency}}', 'CurrencyID');
        $this->batchInsert('country', ['CountryID', 'CountryCode', 'CountryName', 'CountryPhoneCode', 'CountryLatitude', 'CountryLongitude'], [
